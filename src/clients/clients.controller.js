...
var api_key_guard_1 = require("../common/guards/api-key/api-key.guard");
var ClientsController = function () {
    ...
    var ClientsController = _classThis = /** @class */ (function () {
        function ClientsController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        ClientsController_1.prototype.register = function (dto, req) {
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, common_1.UseGuards)(api_key_guard_1.ApiKeyGuard)];
